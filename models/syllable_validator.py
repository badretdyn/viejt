...
class SyllableValidator:
    def __init__(self, phoneme_inventory, restrictions):
    ...
    def __str__(self, separator = " "):
        return f"SyllableValidator {{ phoneme_inventory:{self.phoneme_inventory!r},{separator}restrictions:{self.restrictions},{separator}debug_mode:{self.debug_mode!r} }}"
